    ...
    >
      ...
      >
        ...
        <span
          ...
          className={cn(
            "relative z-10 leading-none whitespace-nowrap",
        ...
        {variant === "secondary" && (
          <span
            aria-hidden="true"
            className="relative z-10 inline-flex origin-left pt-0.75 transition-transform group-hover:animate-jello-vertical"
          >
