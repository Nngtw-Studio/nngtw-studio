...
float lineFn(vec2 st, float width, float perc, float offset, vec2 mouse, float time, float amplitude, float distance) {
    ...
    float split_point = -0.3 + split_offset;

    // By moving the split_point negative, the tight bundle happens off-screen to the left,
    // so it enters the screen already nicely spread out.
