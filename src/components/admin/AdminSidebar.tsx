    ...
    <aside className="fixed top-0 left-0 z-40 flex h-screen w-64 flex-col border-r border-brand-white/5 bg-brand-black">
      <div className="border-b border-brand-white/5 p-6">
        <Link href="/admin" className="block">
          <span className="font-display text-lg tracking-[0.2em] text-brand-white">NNGTW</span>
          <span className="mt-1 block text-[10px] tracking-[0.3em] text-brand-grey uppercase">
            Admin Panel
          </span>
        </Link>
      </div>
